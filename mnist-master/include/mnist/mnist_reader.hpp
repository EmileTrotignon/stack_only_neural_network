 ...
 */
    ...
    bool
    read_mnist_image_file_flat(Container &images, const std::string &path, std::size_t limit, std::size_t start = 0)
    {
 ...
 */
    ...
    read_dataset_3d(const std::string &folder, std::size_t training_limit = 0, std::size_t test_limit = 0)
    {
